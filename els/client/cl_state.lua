...
RegisterNetEvent("FRELS:changeStage", function(netId, stage)
...
RegisterNetEvent("FRELS:toggleSiren", function(netId, tone)
	if not VehicleConfigs then return end
...
RegisterNetEvent("FRELS:toggleBullhorn", function(netId, enabled)
	if not VehicleConfigs then return end
...
RegisterNetEvent("FRELS:patternChange", function(netId, patternIndex, enabled)
	if not VehicleConfigs then return end
...
RegisterNetEvent("FRELS:vehicleRemoved", function(netId)
...
RegisterNetEvent("FRELS:indicatorChange", function(netId, indicator, enabled)
