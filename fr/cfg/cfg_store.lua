...
cfg.items = {
    ...
    ["melee_import"] = {
        name = "Melee Import",
        description = "To use this item open a Weapon Ticket in the FR Support Tickets Discord.",
        manuallyRedeemable = false,
        canTransfer = true
    },
    ["pistol_import"] = {
    ...
    ["fr_plus"] = {
        name = "FR Plus (30 Days)",
        manuallyRedeemable = true,
        canTransfer = true
    },
    ["fr_platinum"] = {
        name = "FR Platinum (30 Days)",
        manuallyRedeemable = true,
        canTransfer = true
    },
    ["supporter"] = {
    ...
    ["lock_slot"] = {
        name = "Lock Slot",
        description = "To use this item open a Ticket in the FR Support Tickets Discord.",
        manuallyRedeemable = false,
        canTransfer = true
    },
    ["import_slot"] = {
        name = "Import Slot",
        description = "To use this item as an import slot open a Ticket in the FR Support tickets Discord.",
        manuallyRedeemable = true,
        canTransfer = true,
        args = "import_slot"
    },
