...
cfg.selectorTypes = {
    ["default"] = {
        _config = {name="Job Selector", blipid = 351, blipcolor = 47, permissions = {}, TextureDictionary = "fr_jobselectorui",texture = "jobcentre"},
        jobs = {
            {"AA Mechanic", 0},
            {"Royal Mail Driver", 0},
            {"Bus Driver", 0},
    ...
    ["casino"] = {
        _config = {name="Casino Jobs", blipid = 351, blipcolor = 47, permissions = {"casino.whitelisted"},TextureDictionary = "fr_jobselectorui", texture = "casinosecurity"},
        jobs = groupCfg.casinoRanks
    },
    ["police"] = {
        _config = {name="Met Police", blipid = 351, blipcolor = 47, permissions = {"cop.whitelisted"}, TextureDictionary = "fr_jobselectorui", texture = "metpd"},
        jobs = groupCfg.metPoliceRanks
    },
    ["nhs"] = {
        _config = {name="NHS Job", blipid = 351, blipcolor = 3, permissions = {"nhs.whitelisted"}, TextureDictionary = "fr_jobselectorui", texture = "nhs"},
        jobs = groupCfg.nhsRanks
    },
    ["lfb"] = {
        _config = {name="LFB Job", blipid = 351, blipcolor = 1, permissions = {"lfb.whitelisted"}, TextureDictionary = "fr_jobselectorui", texture = "lfb"},
        jobs = groupCfg.lfbRanks
    },
    ["hmp"] = {
        _config = {name="Prison Guard", blipid = 351, blipcolor = 1, permissions = {"hmp.whitelisted"}, TextureDictionary = "fr_prisonui", texture = "fr_prisonui"},
        jobs = groupCfg.hmpRanks
    },
    ["border"] = {
        _config = {name="Border Officer", blipid = 351, blipcolor = 1, permissions = {"border.whitelisted"}, TextureDictionary = "fr_jobselectorui", texture = "metpd"},
