        ...
        { -- test route 1 (bay park manoeuvre)
            ...
            },
            {
                ...
                action = function()
                    ...
                    tFR.notifyPicture(cfg.images.dict, cfg.images.govLarge, "Listen carefully for directions, drive to the top floor of the car park", "Reverse Park", "DVSA")
            ...
            },
            {
                ...
                action = function()
                    ...
                    tFR.notifyPicture(cfg.images.dict, cfg.images.govLarge, "Once at the top, you must reverse park in the marked bay.", "Reverse Park", "DVSA")
            ...
            },
            {
                ...
                action = function(currentTest)
                    ...
                    if not seriousIssued then
                        ...
                        local coordsDifference = math.abs(#(tFR.getPlayerCoords() - vector3(361.9121, -1673.248, 48.2865)))
                    ...
                    tFR.notifyPicture(cfg.images.dict, cfg.images.govLarge, "The reverse park exercise is now completed", "Reverse Park", "DVSA")
            ...
            },
            {
                ...
                action = function()
                    dvsaSound("turningRightJunction")
                    tFR.notifyPicture(cfg.images.dict, cfg.images.govLarge, "We are turning right", "DVSA", "Directions")
                end
            },
            {
