...
function loadCrosshairKvp()
    populateArrays()
    local isEnabled = GetResourceKvpInt("fr_crosshair_enabled")
    if isEnabled == 0 then
    ...
    local useCenterDot = GetResourceKvpInt("fr_crosshair_center_dot_enabled")
    ...
    local crosshairVisibility = GetResourceKvpInt("fr_crosshair_visibility")
    ...
    local crosshairLength = GetResourceKvpInt("fr_crosshair_length")
    ...
    local crosshairThickness = GetResourceKvpInt("fr_crosshair_thickness")
    ...
    local crosshairGap = GetResourceKvpInt("fr_crosshair_gap")
    ...
    local red = GetResourceKvpInt("fr_crosshair_red")
    if red == 0 then
    ...
    local green = GetResourceKvpInt("fr_crosshair_green")
    if green == 0 then
    ...
    local blue = GetResourceKvpInt("fr_crosshair_blue")
    if blue == 0 then
...
function saveCrosshair()
    SetResourceKvpInt('fr_crosshair_enabled', cfg.options.enabled)
    SetResourceKvpInt('fr_crosshair_center_dot_enabled', cfg.options.centerDotEnabled)
    SetResourceKvpInt('fr_crosshair_visibility', cfg.options.visibility)
    SetResourceKvpInt('fr_crosshair_length', cfg.options.length.index)
    SetResourceKvpInt('fr_crosshair_thickness', cfg.options.thickness.index)
    SetResourceKvpInt('fr_crosshair_gap', cfg.options.gap.index)
    SetResourceKvpInt('fr_crosshair_red', cfg.options.colour.red)
    SetResourceKvpInt('fr_crosshair_blue', cfg.options.colour.blue)
    SetResourceKvpInt('fr_crosshair_green', cfg.options.colour.green)
end
