globalBlips = {}
function tFR.addBlip(a, b, c, d, e, f, g, h)
...
function tFR.removeBlip(j)
    RemoveBlip(j)
end
function tFR.removeBlipAtCoords(x,y,z) -- used to remove green house blips for everyone when purchased
...
local k = {}
function tFR.setNamedBlip(l, a, b, c, d, e, f, g)
    tFR.removeNamedBlip(l)
    k[l] = tFR.addBlip(a, b, c, d, e, f, g)
    return k[l]
end
function tFR.removeNamedBlip(l)
    if k[l] ~= nil then
        tFR.removeBlip(k[l])
        k[l] = nil
    end
end
function tFR.setGPS(a, b)
    SetNewWaypoint(a + 0.0001, b + 0.0001)
end
function tFR.setBlipRoute(j)
    SetBlipRoute(j, true)
end
local m = {}
...
local p = {}
local q = {}
function tFR.addMarker(a, b, c, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F, G, H)
    local I = {
...
function tFR.setNamedMarker(l, a, b, c, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F, G, H)
    tFR.removeNamedMarker(l)
    o[l] = tFR.addMarker(a, b, c, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F, G, H)
    return o[l]
end
function tFR.removeNamedMarker(l)
    if o[l] ~= nil then
        tFR.removeMarker(o[l])
        o[l] = nil
    end
end
local J = {}
...
Citizen.CreateThread(
    function()
        while true do
            q = tFR.getNearbyMarkers()
            Citizen.Wait(10000)
        end
    end
)
function tFR.getNearbyMarkers()
    local N = {}
    local O = tFR.getPlayerCoords()
    local P = 0
...
function tFR.setArea(l, a, b, c, T, U)
...
RegisterCommand("nextblip",function()
    ...
    a4 = tFR.addBlip(1103.9739990234, 211.95138549805, -49.440101623535, a5, 0, "Chips Cashier", 0.8, true)
end)
