...
--     if GetResourceState('fr-ac') == "started" then
--         for group, groupPermissions in pairs(FGconfig) do
--             if FR.hasGroup(user_id, group) then
...
--                             exports['fr-ac']:SetTempPermission(user_id, category, permission, true, true)
--                         end
--                     end
--                 end
--                 break
...
--     end
-- end)
-- RegisterServerEvent('FR:FiveGuard:givePermissionToPlayer', function(user_id)
