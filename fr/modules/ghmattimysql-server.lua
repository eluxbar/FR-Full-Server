...
exports('executeSync', function (query, parameters)
  ...
  exports.fr:execute(query, safeParameters(parameters), function (result)
    res = result
    finishedQuery = true
...
exports('scalarSync', function (query, parameters)
  local res = {}
  local finishedQuery = false
  exports.fr:scalar(query, safeParameters(parameters), function (result)
    res = result
    finishedQuery = true
  end, GetInvokingResource())
  repeat Citizen.Wait(0) until finishedQuery == true
...
exports('transactionSync', function (query, parameters)
  ...
  exports.fr:transaction(query, safeParameters(parameters), function (result)
    res = result
...
exports('storeSync', function (query)
  ...
  exports.fr:store(query, function (result)
    res = result
    finishedStore = true
  end, GetInvokingResource())
