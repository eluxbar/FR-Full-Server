RegisterServerEvent("FR:serverIssue")
AddEventHandler("FR:serverIssue", function(idk, idk2, idk3)
    local embedMsg = {
        {
...
RegisterServerEvent("FR:clientIssue")
AddEventHandler("FR:clientIssue", function(idk, idk2, idk3)
    local embedMsg = {
        {
            color = 16711680,
            title = "Client Error",
