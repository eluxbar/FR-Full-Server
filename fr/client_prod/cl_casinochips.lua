...
RMenu:Get("FRChips", "cashier"):SetSubtitle("CHIPS")
RMenu.Add(
    "casino_enter",
    "casino",
    RageUI.CreateMenu(
...
RageUI.CreateWhile(
    ...
    true,
    function()
        if RageUI.Visible(RMenu:Get("FRChips", "cashier")) then
            RageUI.DrawContent(
                ...
                function()
                        ...
                        function(l, m, n)
                            if n then
                                ...
                                if tonumber(o) then
                                    o = tonumber(o)
                                    if o > 0 then
                                        TriggerServerEvent("FR:buyChips", o)
                                    else
                                        tFR.notify("Negative amount.")
                                    end
                                else
                                    tFR.notify("~r~Invalid amount.")
                                end
                            end
                        end
                    )
                    RageUI.ButtonWithStyle(
                        ...
                        function(l, m, n)
                            if n then
                                TriggerServerEvent("FR:buyChips")
                            end
                        end
                    )
                    RageUI.ButtonWithStyle(
                        ...
                        function(l, m, n)
                            if n then
                                ...
                                if tonumber(o) then
                                    o = tonumber(o)
                                    if o > 0 then
                                        TriggerServerEvent("FR:sellChips", o)
                                    else
                                        tFR.notify("Negative amount.")
                                    end
                                else
                    ...
                    RageUI.ButtonWithStyle(
                        ...
                        function(l, m, n)
                            if n then
                                TriggerServerEvent("FR:sellChips")
                            end
                        end
                    )
                end
            ...
            RageUI.DrawContent(
                ...
                function()
                    RageUI.ButtonWithStyle(
                        ...
                        function(l, m, n)
                            if n then
                                TriggerServerEvent("FR:exitDiamondCasino")
                                tFR.teleport(e.x, e.y, e.z)
                                if cardObjects then
            ...
            RageUI.DrawContent(
                ...
                function()
                    RageUI.ButtonWithStyle(
                        ...
                        true,
                        function(l, m, n)
                            if n and tFR.getPlayerCombatTimer() == 0 then
                                TriggerServerEvent("FR:enterDiamondCasino")
                                tFR.teleport(f.x, f.y, f.z)
                            end
                        end
                    )
                    RageUI.ButtonWithStyle(
...
function showCasinoChipsCashier(s)
    ...
    RageUI.Visible(RMenu:Get("FRChips", "cashier"), s)
end
...
Citizen.CreateThread(
    function()
        while true do
            local t = GetEntityCoords(tFR.getPlayerPed())
            a = #(t - e)
            b = #(t - f)
            c = #(t - g)
            Wait(100)
...
RegisterNetEvent("FR:setDisplayChips")
AddEventHandler(
    "FR:setDisplayChips",
    function(v)
    ...
    function(x, y)
        if y then
            ...
            for C, k in pairs(h) do
                tFR.addBlip(k.entryPosition.x, k.entryPosition.y, k.entryPosition.z, 683, 0, "Chips Cashier", 0.7, true)
                tFR.addMarker(
                    k.entryPosition.x,
                    k.entryPosition.y,
                    k.entryPosition.z,
                ...
                tFR.createArea("chipscashier_" .. C, k.entryPosition, 1.5, 6, z, y, A, {})
            end
